...
upsun variable:create --level project --name BRIGHTDATA_BASE_URL --value "https://trackfutura.futureobjects.io" --sensitive false
upsun variable:create --level project --name BRIGHTDATA_WEBHOOK_TOKEN --value "your-webhook-secret-token" --sensitive true
upsun variable:create --level project --name OPENAI_API_KEY --value "your-openai-api-key" --sensitive true
...
Write-Host "   Frontend: https://trackfutura.futureobjects.io" -ForegroundColor Cyan
Write-Host "   API: https://api.trackfutura.futureobjects.io" -ForegroundColor Cyan
Read-Host "Press Enter to exit"
