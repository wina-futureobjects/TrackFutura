#!/usr/bin/env python3
"""
Test script for Apify Facebook scraper integration
"""
...
async def test_facebook_scraper():
    ...
    print("Testing Apify Facebook Scraper")
    print("=" * 50)
    ...
    try:
        ...
        job = await service.create_scraping_job(
            name="Test Facebook Scrape - Microsoft",
            project_id=9,  # Use default project ID
            platform="facebook",
            content_type="posts",
            target_urls=["https://www.facebook.com/Microsoft"],
