#!/usr/bin/env python3
"""
Test script for Apify LinkedIn scraper integration
"""
...
async def test_linkedin_scraper():
    """Test LinkedIn scraping with Apify"""
    ...
    try:
        ...
        job = await service.create_scraping_job(
            name="Test LinkedIn Scrape - Microsoft",
            project_id=9,  # Use default project ID
            platform="linkedin",
            content_type="posts",
            target_urls=["https://www.linkedin.com/company/microsoft/"],
            source_names=["Microsoft"],
            num_of_posts=5,
