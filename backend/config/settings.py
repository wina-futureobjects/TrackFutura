...
INSTALLED_APPS = [
    ...
    # Local apps
    "health",  # Health check app for Upsun
    "users",
    "reports",
    "analytics",
    "data_collector",
    ...
    "scrapy_integration",  # New Scrapy-based scraper
    "apify_integration",   # Apify integration for scraping
    "chat",
    "workflow",
]
...
# WhiteNoise configuration for Upsun
...
if (os.getenv('PLATFORM_APPLICATION_NAME') is not None):
    ...
    try:
        ...
        # Fallback to basic production settings
        DEBUG = False
        ...
        # Production database configuration for Upsun
